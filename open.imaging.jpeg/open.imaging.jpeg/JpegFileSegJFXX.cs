...
namespace open.imaging.jpeg
{
  ...
  public class JpegFileSegJFXX : JpegFileSeg
  {
    internal JpegFileSegJFXX()
    { }

    public JpegFileSegJFXX(JpegFile jpegFile, JpegFileSegMarker id, JpegBinaryReader reader)
    ...
    public override int Compare(JpegFileSeg other)
    {
      ...
      if (null == other.AsJFXX)
      {
        throw (new ArgumentNullException("JpegFileSeg other argument must be of type JpegFileSegJFXX."));
      }
    ...
    public override string ToString()
    {
      ...
      return string.Format("JpegFileSegJFXX\t:\t{{ a: 0x{0,8:x8}, id: {1,-5} ({2,4:X4}.h), size: {3,5} (0x{4,4:x4}), signature:'{5}' }}",
                            _address,
                            MarkerId,
                            ((ushort)MarkerId),
                            size,

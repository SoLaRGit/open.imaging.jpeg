...
namespace open.imaging.jpeg
{
  ...
  public class JpegFileSegAPPADOBE : JpegFileSeg
  {
    internal JpegFileSegAPPADOBE()
    { }

    public JpegFileSegAPPADOBE(JpegFile jpegFile, JpegFileSegMarker id, JpegBinaryReader reader)
    ...
    {
      return string.Format("JpegFileSegAPPADOBE\t:\t{{ a: 0x{0,8:x8}, id: {1,-5} ({2,4:X4}.h), size: {3,5} (0x{4,4:x4}), signature:'{5}' }}",
              _address,
              MarkerId,
              ((ushort)MarkerId),
              size,

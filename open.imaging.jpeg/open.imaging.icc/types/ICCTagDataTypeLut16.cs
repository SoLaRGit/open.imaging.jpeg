...
namespace open.imaging.icc.types
{
  /// <summary>
  /// 10.8 lut16Type
  /// <remarks>Table 37 — lut16Type encoding.</remarks>
  /// </summary>
  [XmlRoot("ICCTagDataTypeLut16")]
  [XmlType("ICCTagDataTypeLut16")]
  public class ICCTagDataTypeLut16: ICCTagData
  {
    public const uint ID = 0x6D667432; // 'mft2'

    public ICCTagDataTypeLut16()
    { }

    public ICCTagDataTypeLut16(byte[] data)
      : base(data)
    { }
    ...
    [XmlIgnore]
    public ushort InputTableEntries
    {
      get { return get_u2(48); }
      set { set_u2(48, value); NotifyPropertyChanged(); }
    }

    [XmlIgnore]
    public ushort OutputTableEntries
    {
      get { return get_u2(50); }
      set { set_u2(50, value); NotifyPropertyChanged(); }
    }

    [XmlIgnore]
    public const int InputTableOffset = 52;

    [XmlIgnore]
    public int InputTableSize
    {
      get { return (int)(2 * InputTableEntries * InputChannels); }
    }
    ...
    {
      get { return (int)(2 * Math.Pow(CLUTGridPoints, InputChannels) * OutputChannels); }
    }
    ...
    {
      get { return 2 * OutputTableEntries * OutputChannels; }
    }
        ...
        case 1:
          {
            ...
            data[8] = (byte)(arraySize / (2*InputTableEntries));
          }
          break;
        case 2:
          {
            ...
            // arraySize = 2*(g^i)*o; g = ((arraySize/o) ^ (1/i)) / 2;
            data[10] = (byte)(Math.Pow(arraySize / OutputChannels, (double)1 / InputChannels) / 2);
          }
          break;
        case 3:
          {
            ...
            this.data[9] = (byte)(arraySize / (2 * OutputTableEntries));
          }
          break;
      }
